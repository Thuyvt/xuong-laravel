                    ...
                    <table id="example"
                        ...
                        @foreach($data as $item)
                            <tr>
                                ...
                                <td>{!! $item->is_best_sale ? '<span class="badge bg-primary">YES</span>'
                                                                : '<span class="badge bg-danger">NO</span>' !!}</td>
                                <td>{!! $item->is_40_sale ? '<span class="badge bg-primary">YES</span>'
                                                                : '<span class="badge bg-danger">NO</span>' !!}</td>
                                <td>{!! $item->is_hot ? '<span class="badge bg-primary">YES</span>'
                                                                : '<span class="badge bg-danger">NO</span>' !!}</td>
                                <td>
